...
export function AdminAccessDenied({ user }: Props) {
    const email =
        ...
        "Chưa xác định";
    const displayName =
        user?.fullName || user?.firstName || user?.username || "Tài khoản";
    const currentRole =
                ...
                <div className="bg-gradient-to-r from-amber-500 to-rose-500 p-6 text-white flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-amber-100 text-xs mt-0.5">
                            Tài khoản hiện tại không có quyền truy cập vào cổng
                            quản trị Microservices.
                        </p>
                    </div>
                </div>
                ...
                <div className="p-6 md:p-8 space-y-6">
                    ...
                    <div className="space-y-3">
                        <h3 className="text-sm font-bold text-slate-900 flex items-center gap-2">
                            ...
                            Cách cấp quyền Quản trị viên (Admin) cho tài khoản
                            này:
                        </h3>
                        ...
                        <div className="space-y-3 text-xs text-slate-700">
                            ...
                            <div className="p-3.5 rounded-lg border border-amber-200 bg-amber-50/60 space-y-1.5">
                                <div className="font-bold text-amber-900 flex items-center gap-1.5">
                                    ...
                                    Cách 1 (Nhanh nhất khi chạy Local): Cấu hình
                                    file .env.local
                                </div>
                                <p className="text-slate-600">
                                    Mở file{" "}
                                    <code className="px-1.5 py-0.5 bg-amber-100 rounded text-amber-900 font-mono font-bold">
                                        WebApps/Shopping.Client/.env.local
                                    </code>{" "}
                                    và thêm dòng:
                                </p>
                                ...
                                <p className="text-slate-500 text-[11px]">
                                    Sau đó lưu file và khởi động lại dev server
                                    (nếu cần).
                                </p>
                            </div>
                            ...
                            <div className="p-3.5 rounded-lg border border-slate-200 bg-slate-50 space-y-1.5">
                                <div className="font-bold text-slate-800 flex items-center gap-1.5">
                                    ...
                                    Cách 2 (Chuẩn Clerk): Cấp role trong Clerk
                                    Dashboard
                                </div>
                                <p className="text-slate-600">
                                    Vào <strong>Clerk Dashboard</strong> &gt;{" "}
                                    <strong>Users</strong> &gt; Chọn tài khoản{" "}
                                    <strong>{email}</strong> &gt; mục{" "}
                                    <strong>Metadata</strong> &gt;{" "}
                                    <strong>Public metadata</strong>, điền:
                                </p>
                            ...
                            <div className="p-3.5 rounded-lg border border-slate-200 bg-slate-50 space-y-1">
                                <span className="font-bold text-slate-800">
                                    Cách 3: Đăng nhập bằng tài khoản có email
                                    quản trị
                                </span>
                                <p className="text-slate-600">
                                    Tài khoản có email bắt đầu bằng{" "}
                                    <code className="px-1 py-0.5 bg-slate-200 rounded font-mono">
                                        admin@...
                                    </code>{" "}
                                    (ví dụ:{" "}
                                    <code className="px-1 py-0.5 bg-slate-200 rounded font-mono">
                                    ...
                                    ) sẽ tự động được nhận diện là Admin.
                                </p>
                            </div>
                        </div>
                    </div>
